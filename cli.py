...
@click.command()
@click.option("--api", default="serverapi", help="The API Name.", type=str)
@click.option("--authentication", default=True, help="Set authentication.", type=bool)
@click.option("--port", default=8080, help="Tell Port on which you have to run the server.", type=int)

def main(api, authentication, port):
    ...
    with set_authentication(app, authentication):
