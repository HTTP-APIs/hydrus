""" Command Line Interface for setting up Hydrus with any db and any API Doc."""
...
@click.option("--port", default=8080,
			           help="Port on which the appmust be hosted",\
			           type=int)
@click.option("--auth/--no-auth", default=True,
			           help="Turns on/off User Authentication")
@click.argument("runserver", required=True)
def main(hydradoc, port, auth, runserver):
    """Command Line Interface For The Python Hydrus Server"""
