# Autogenerated using hydrus.hydraspec.parser

parsed_classes = [{'@id': 'http://ontology.projectchronos.eu/subsystems/cubicMillimeters',
                   '@type': 'hydra:Class',
                   'description': 'unit of measure for volume',
                   'supportedOperation': [{'@id': '_:cubicMillimeters_create',
